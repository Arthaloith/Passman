...
root.config(padx=50, pady=50, bg=AQUA)

# 1st field
canvas = Canvas(height=200, width=200, bg=AQUA, highlightthickness=0)
img = PhotoImage(file='key.png')
canvas.create_image(100, 100, image=img)
canvas.grid(row=0,column=1)

# 2nd field
website_label = Label(text='Website:', bg=AQUA, fg=BEIGE)
...
# 3rd field
email_label = Label(text='Email/Username:', bg=AQUA, fg=BEIGE)
...
# 4th field
password_label = Label(text='Password:', bg=AQUA, fg=BEIGE)
